          ...
          <div key={card.id} className="relative">
            ...
            >
              {displayImage ? (
                ...
                <div className="aspect-[2.5/3.5] bg-gray-100 flex flex-col items-center justify-center p-3 gap-2">
                  <svg
                  ...
                  <p className="text-gray-400 text-xs text-center leading-tight line-clamp-2">
                    {card.name || "No image"}
                  </p>
                </div>
              )}
