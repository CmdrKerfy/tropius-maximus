/**
 * db.duckdb.js — DuckDB-WASM + IndexedDB database layer (v1 static site).
 *
 * Routed through ./db.js unless VITE_USE_SUPABASE=true (see Supabase adapter).
 */
...
export async function fetchMatchingCardIds() {
...
export async function fetchDataHealthSummary() {
  return {
    totalCards: null,
    annotationRows: null,
    cardsWithoutAnnotationRow: null,
    sets: null,
    fieldDefinitions: null,
    customFieldDefinitions: null,
    pokemonMetadataRows: null,
    normalizationRules: null,
    workbenchQueues: null,
...
/** DuckDB mode: no server-side workbench queues (v2 / Supabase only). */
...
export async function updateWorkbenchQueue() {
