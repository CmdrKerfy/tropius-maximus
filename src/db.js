...
const PROMOTED_STRING_FIELDS = [
  ...
  "weather_environment","storytelling","card_locations","pkmn_region","card_region",
    ...
    if (existing.numRows === 0) {
      ...
      await conn.query(`
        INSERT INTO custom_cards (
          ...
          ${s('weather_environment')}, ${s('storytelling')}, ${s('card_locations')}, ${s('pkmn_region')}, ${s('card_region')},
