...
('camera_angle', 'Camera Angle', 'multi_select', 'visual', 50, '["Aerial","Profile","Underbelly","Upside Down","Symmetrical","Reflection","Water Level","POV","Confusing Perspective","My Eyes Are Up Here","Staring Contest","Nature Photographer","Zoomed In","curved landscape","selfies","off center"]'),
